export function PawsBackLogo({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <ellipse cx="24" cy="32" rx="10" ry="8" fill="#1C5426" />

      <ellipse cx="13" cy="20" rx="5" ry="6" fill="#1C5426" />
      <ellipse cx="20" cy="15" rx="5" ry="6" fill="#1C5426" />
      <ellipse cx="28" cy="15" rx="5" ry="6" fill="#1C5426" />
      <ellipse cx="35" cy="20" rx="5" ry="6" fill="#1C5426" />
