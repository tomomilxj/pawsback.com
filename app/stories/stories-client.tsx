  ...
  const testimonials = [
    {
      ...
      story:
        language === "en"
          ...
          : language === "zh"
            ? "8个月前我失去了Luna,悲痛难以承受。PawsBack让我再次感受到她的存在。我可以抚摸她的头,听到她的叫声,就像她从未离开一样。这真的非常治愈。"
            : "J'ai perdu Luna il y a 8 mois et le chagrin était insupportable. PawsBack m'a donné un moyen de ressentir à nouveau sa présence.",
    },
    {
      name: "Michael Chen",
      ...
      story:
        language === "en"
          ...
          : language === "zh"
            ? "我的猫Whiskers陪伴了我15年。当他去世时,我不知道如何应对。PawsBack让我听到他的呼噜声,看到他歪头的样子。在最艰难的时刻给了我很大的安慰。"
            : "Mon chat Whiskers était mon compagnon pendant 15 ans. Quand il est décédé, je ne savais pas comment faire face.",
    },
    {
      ...
      story:
        language === "en"
          ...
          : language === "zh"
            ? "Max是我大学时期及之后最好的朋友。失去他就像失去了自己的一部分。有了PawsBack,我仍然可以告诉他我的一天,他会以他那顽皮的方式'回应'。这真的很神奇。"
            : "Max était mon meilleur ami pendant l'université et au-delà. Le perdre était comme perdre une partie de moi-même.",
    },
    {
      name: "James Wilson",
      location: "London, UK",
      ...
      story:
        language === "en"
          ...
          : language === "zh"
            ? "Bella突然去世,我还没有准备好说再见。PawsBack成为了悲伤和接受之间的桥梁。我可以每天与她互动,这帮助我以自己的节奏处理失去的痛苦。"
            : "Bella est décédée soudainement et je n'étais pas prêt à dire au revoir.",
    },
    {
      name: "Maria Garcia",
      ...
      story:
        language === "en"
          ...
          : language === "zh"
            ? "Shadow做了我12年的保护者。没有他的房子感觉很空。现在我可以再次看到他摇尾巴,听到他低沉的叫声。PawsBack让我的生活重新充满光明。"
            : "Shadow était mon protecteur pendant 12 ans. La maison semblait vide sans lui.",
    },
    {
      name: "David Kim",
      ...
      story:
        language === "en"
          ...
          : language === "zh"
            ? "Coco是最小的狗,却有着最大的个性。失去她留下了巨大的空虚。多亏了PawsBack,我仍然可以体验她活泼的能量,听到她兴奋的叫声。这种治愈超越了语言。"
            : "Coco était le plus petit chien avec la plus grande personnalité.",
    },
  ]
